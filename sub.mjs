...
} from "@remotion/install-whisper-cpp/dist/install-whisper-cpp.js";
...
console.log("Using Whisper executable at", getWhisperExecutablePath(WHISPER_PATH, WHISPER_VERSION));
